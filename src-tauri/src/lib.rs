...
mod app_init {
    ...
    pub fn setup_plugins(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
        ...
        let mut builder = builder
            .plugin(tauri_plugin_ns_vpn_sysinfo::init())
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            tauri_plugin_ns_vpn_sysinfo::commands::get_system_info,
            tauri_plugin_ns_vpn_sysinfo::commands::get_app_uptime,
            tauri_plugin_ns_vpn_sysinfo::commands::app_is_admin,
            tauri_plugin_ns_vpn_sysinfo::commands::export_diagnostic_info,
            cmd::probe_listener,
    ...
    let builder = app_init::setup_plugins(tauri::Builder::default())
        .setup(|app| {
            ...
            fn log_setup_panic(stage: &str, panic: Box<dyn std::any::Any + Send>) {
                ...
                eprintln!("[ns-vpn] panic during app setup ({stage}), continuing in degraded mode: {msg}");
                logging!(
                    error,
                    Type::Setup,
