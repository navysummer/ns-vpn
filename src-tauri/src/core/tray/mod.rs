...
use ns_vpn_limiter::{Limiter, SystemClock, SystemLimiter};
use ns_vpn_logging::logging_error;
...
impl Tray {
    ...
    pub async fn update_tooltip(&self) -> Result<()> {
        ...
        let sys_proxy_text = ns_vpn_i18n::t!("tray.tooltip.systemProxy");
        let tun_text = ns_vpn_i18n::t!("tray.tooltip.tun");
        let profile_text = ns_vpn_i18n::t!("tray.tooltip.profile");
...
async fn create_tray_menu(
    ...
    let outbound_modes = if show_outbound_modes_inline {
        ...
        let current_mode_text = match current_proxy_mode {
            "global" => ns_vpn_i18n::t!("tray.global"),
            "direct" => ns_vpn_i18n::t!("tray.direct"),
            _ => ns_vpn_i18n::t!("tray.rule"),
        };
