...
function buildNotice(
  ...
  type: NoticeType,
  duration: number,
  payload: { message?: any; i18n?: NoticeTranslationDescriptor },
  timerId?: ReturnType<typeof setTimeout>,
): NoticeItem {
  return {
    id,
...
function normalizeNoticeMessage(
  ...
  params?: Record<string, unknown>,
  raw?: unknown,
): { message?: any; i18n?: NoticeTranslationDescriptor } {
  ...
  if (message && typeof message === 'object' && '__vnode' in (message as any)) {
    return { message }
  }
